...
export interface Deposit { id: string; trip_id: string; member_id: string; member_name: string; member_display_name?: string; amount: number; note: string; created_at: string; }
...
export interface Withdrawal { id: string; trip_id: string; description: string; category: string; amount: number; created_at: string; beneficiaries: Beneficiary[]; }
